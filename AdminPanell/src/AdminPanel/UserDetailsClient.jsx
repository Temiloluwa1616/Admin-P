...
const UserDetailsClient = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://wild-gold-coyote-wear.cyclic.app/api/client/get-single-client/${id}`)
      .then(response => {
 ...
 <div>
        ...
        <img src={image} alt="" />
        <p  className='text-white text-[20px] text-center font-bold'> {userData.fullname}</p>
